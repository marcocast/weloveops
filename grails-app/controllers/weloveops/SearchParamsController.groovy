...
class SearchParamsController {
    ...
    def save(SearchParams searchParamsInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'searchParamsInstance.label', default: 'SearchParams'), searchParamsInstance.id])
    ...
    def update(SearchParams searchParamsInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'SearchParams.label', default: 'SearchParams'), searchParamsInstance.id])
                redirect searchParamsInstance
            }
    ...
    def delete(SearchParams searchParamsInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'SearchParams.label', default: 'SearchParams'), searchParamsInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'searchParamsInstance.label', default: 'SearchParams'), params.id])
                redirect action: "index", method: "GET"
            }
